...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNameEditText=(EditText)findViewById(R.id.e_user_name) ;
        mPwdEditText=(EditText)findViewById(R.id.e_user_password);
        mLoginButton =(Button) findViewById(R.id.b_btn_login);
